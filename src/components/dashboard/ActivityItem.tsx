...
export function ActivityItem({ activity }: { activity: ActivityLog }) {
  return (
    <div className="flex gap-2.5 border-b border-paper-2 py-[9px] text-[0.78125rem] last:border-b-0">
      ...
      <div>
        ...
        <div className="text-[0.6875rem] text-gray">{formatRelativeBn(activity.createdAt)}</div>
      </div>
    </div>
  );
}
