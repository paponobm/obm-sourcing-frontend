...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-line bg-white p-6 shadow-panel transition ease-in-out",
  {
    variants: {
      side: {
        right:
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("font-serif text-lg text-teal-dark", className)} {...props} />
));
